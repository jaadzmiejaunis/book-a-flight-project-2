...
<head>
    ...
    <title>Staff Homepage - SierraFlight</title>
...
<body>
    ...
    <div class="top-gradient-bar">
        <div class="container">
            <a href="homepage_staff.php" class="site-title">SierraFlight (Staff)</a> <div class="user-info">
                <?php if ($loggedIn): ?>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav mr-auto">
                     <li class="nav-item active"> <a class="nav-link" href="staff_homepage.php">Home <span class="sr-only">(current)</span></a>
                     </li>
                     <li class="nav-item">
                         <a class="nav-link" href="staff_about.php">About</a> </li>
                     <li class="nav-item">
        ...
        <div class="container">
            <div class = "firstRow row">
                <div class = "col firstColumn">
                    <h1 class="display-4">Welcome, Staff!</h1> <p class="lead">Staff Panel Homepage</p>
                </div>
    ...
    <div class="jumbotron">
        <div class="container">
            <p><a class="btn btn-primary btn-lg" href="" role="button">Sales Report</a></p>
            <p><a class="btn btn-primary btn-lg" href="" role="button">View Booking Status</a></p>
            <p><a class="btn btn-primary btn-lg" href="" role="button">User Feedback</a></p>
        </div>
    </div>
